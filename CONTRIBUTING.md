...
This creates the directory sas7bdat-converter and connects your repository to the upstream
...
sas7bdat-converter uses [ruff](https://github.com/charliermarsh/ruff),
[Black](https://github.com/psf/black), and [mypy](https://mypy.readthedocs.io/en/stable/)
...
for testing. Please ensure that any additions/changes you make to the code have tests to go along
with them. Code coverage should not drop blow it's current level with any pull requests you make,
if it does the pull request will not be accepted. You can view the current coverage level in the
codecov badge on the
...
After pushing your code to origin it is now on GitHub but not yet part of the sas7bdat-converter
...
tests, and documentation. You should also double check your branch changes
...
of the sas7bdat-coverter project know you have code ready to be reviewed. To submit the pull request:
...
After the feature branch has been update locally, you can now update your pull request by pushing
